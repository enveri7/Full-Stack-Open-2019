  ...
  <div>
    ...
    <ul>
      {anecdotes.map(anecdote => {
        return (
          <li key={anecdote.id}>
            <Link key={anecdote.id} to={`/anecdotes/${anecdote.id}`}>{anecdote.content}</Link>
          </li>
        )
      })}
    </ul>
    ...
    <div>
      ...
      <Router>
        <div>
          ...
          <Route exact path="/create" render={() => <CreateNewWithRouter showNotification={showNotification} addNew={addNew} />} />
